...
let chiliCheesePotato = MenuItem(name: "칠리 치즈 감자 베이크", description: "따뜻하고 폭신한 감자에 시그니처 고기와 풍미 가득한 칠리, 크리미한 치즈 소스, 슈레드 치즈까지!! 당신의 최애 메뉴가 될 겁니다!", price: 1400, image: "chiliCheesePotato", calories: 428, type: .side)
